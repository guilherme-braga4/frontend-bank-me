...
const Dashboard = ({ session }) => {
  const [payableActive, setPayableActive] = useState<boolean>(false);
  const [assignorActive, setAssignorActive] = useState<boolean>(false);
            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <button
                    onClick={() => {
                      setPayableActive(true);
                      setAssignorActive(false);
                    }}
                    className={
                      payableActive
                  ...
                  <button
                    onClick={() => {
                      setAssignorActive(true);
                      setPayableActive(false);
                    }}
                    className={
                      assignorActive
                        ? "bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium"
